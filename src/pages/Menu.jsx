  ...
  return (
    <div className="flex flex-col justify-center items-center w-[100%] h-[auto] relative">
      ...
      <div className="w-[343px] h-[100%] flex flex-col justify-start items-start">
        ...
        <span className="flex justify-start items-start  font-raleway text-[16px] text-white mt-[2px]">
          <span>4) 4 фотографии в профиле (за каждую фотографию</span>
          <span className="flex font-bold">+25</span>
          <img src="/icons/myta-coin.svg" className="mx-2" alt="" />)
        </span>
