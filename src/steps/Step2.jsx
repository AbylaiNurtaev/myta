        ...
        <div className="flex flex-col items-center w-[343px] h-[100%] overflow-x-hidden overflow-y-hidden">
            ...
            <div className={`w-[343] h-[343] mt-5 grid grid-cols-2 gap-[15px]`}>
                <div id="photo1"
                    ...
                    <img src="/icons/main_photo_label.svg" className="absolute top-0 left-0"/>
            ...
            <h1 className="font-raleway font-light mt-3 text-white text-[16px]">Перетащите чтобы изменить порядок</h1>
            <Button
