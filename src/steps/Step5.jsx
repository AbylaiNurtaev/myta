...
function Step4({setStep}) {
    ...
    return (
        <div className="flex flex-col items-center w-[343px] h-[100%] overflow-x-hidden overflow-y-hidden">
            ...
            <h1 className="font-raleway font-light mt-2 text-white text-center text-[16px]">Выберите не менее 5 интересов, чтобы поделиться ими с другими пользователями</h1>
